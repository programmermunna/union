        ...
        <div class="col-12">
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              ...
              <div>
                <span class="add_new"><a style="margin-left:20px" class="btn_on_red" href="section.php"> রিফ্রেস </a></span>
                <span class="add_new"><a style="margin-left:20px" class="btn_on_red" href="section-add.php"> পাড়া যুক্ত করুণ</a></span>
              </div>
              <div>
                <h6 class="text-white text-capitalize"><a style="color:#fff" href="section.php">পাড়া সমূহ</a></h6>
              </div>
              <div>
