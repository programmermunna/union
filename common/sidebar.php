<nav id="side_nav" class="side_nav">
        ...
        <a href="expense-all.php">
          <button class="btn nav_btn"><span class="nav_icon order_icon"> </span><span class="nav_text">Expense</span></button>
        </a>

        <a href="customer-all.php">
          <button class="btn nav_btn"><span class="nav_icon seller_icon"> </span><span class="nav_text">Customer</span></button>
        </a>

        <a href="brand.php">
          <button class="btn nav_btn"><span class="nav_icon product_icon"> </span><span class="nav_text">Brand</span></button>
        </a>

        <a href="category-all.php">
          <button class="btn nav_btn"><span class="nav_icon product_icon"> </span><span class="nav_text">Categorie</span></button>
        </a>

        <a href="product-all.php">
          <button class="btn nav_btn"><span class="nav_icon product_icon"> </span><span class="nav_text">Products</span></button>
        </a>
